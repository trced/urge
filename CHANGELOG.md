...
- The "famille ." 1.2.0 design system as CSS tokens: colour, typography, space, shape, motion, and the shared components (button, text field, setting row, list row, stat row, sheet, period navigation, feedback). urge. adds no colour to the common trunk — its vocabulary is made of words, never of hues
